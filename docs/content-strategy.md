...
Status: proposed. Written 30 Jul 2026. Companion to docs/payload-cms-plan.md
(the CMS is the delivery vehicle; this doc decides what the content says).
Voice rules in docs/DESIGN.md still govern everything here.

Goal: a site that reads ready to open. That means three things: the seasonal
story is true to Naivasha instead of borrowed from Europe, every link and nav
item leads somewhere real, and all copy sounds like one brand wrote it.
...
## 2. The Naivasha year (climate truth)

Lake Naivasha sits at roughly 1,900 m, so days are warm and nights are cool
all year. The year splits the way the whole Kenyan calendar does:

| Months | What it is like at the lake |
| --- | --- |
| December to February | Hottest, driest, clearest. Lagoon and lake-morning weather |
| March to May | The long rains. Afternoon storms, dramatic skies, everything green, fewest visitors |
| June to September | Cool and dry. Misty forest mornings, cool nights, fireplace weather |
...
- Season content reworked to the four rows above. Two new photos needed
  (sunshine: sunny lake or lagoon; cool season: misty forest), Pexels with
...
- Two FAQ additions: "When is the best time to visit?" (answer: the four
  ...
  rains) and "How do we get there?" (about 90 minutes from Nairobi, down the
  Rift Valley escarpment; parking included, plate captured at booking for
  the gate).
...
| Village page | The character page the nav's "Discover Unity Parks" deserves: karibu welcome, the map, wildlife neighbours (hippos, fish eagles, colobus), getting there, the four seasons strip |
...
| Village news | Small News collection, three seed posts (building the village, meet the lodges, living with hippos). Powers the "Village news" discover card's dead link |
...
- Real photography: the governed Pexels set stays until a real shoot. The
  two orphaned videos (band-forest-lake, band-forest-mood) are earmarked for
  the village and campaign pages; if unused when those ship, delete them.
...
- Ground in real places and real nature: Lake Naivasha, the Rift Valley
  escarpment, Nairobi, hippos, fish eagles, colobus monkeys. Never invent
  geography.
- Swahili is seasoning, not sauce: "karibu" belongs on the village page
  welcome and nowhere else. No phrasebook copy.
...
- School holidays are the demand language: copy says "the August holidays",
  not "summer break".
- Wildlife is a neighbour, not a threat and not a zoo: the hippo FAQ's tone
  (safety, respect, a little wonder) is the template.
...
is not). Definition of done: nothing on the site contradicts the Naivasha
